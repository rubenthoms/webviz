...
export function useViewStatusWriter(viewContext: ViewContext<any, any, any>): ViewStatusWriter {
...
export function useSettingsStatusWriter(settingsContext: SettingsContext<any, any, any>): SettingsStatusWriter {
