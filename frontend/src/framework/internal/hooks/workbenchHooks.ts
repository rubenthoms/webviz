...
export function useModuleInstances(workbench: Workbench): ModuleInstance<any, any, any, any, any>[] {
    const [moduleInstances, setModuleInstances] = React.useState<ModuleInstance<any, any, any, any, any>[]>([]);
