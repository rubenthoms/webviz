...
import { ExtendedLayerProps, MapMouseEvent, PropertyDataType } from "@webviz/subsurface-viewer";
...
export function hasPropertiesArray(obj: any): obj is { properties: PropertyDataType[] } {
    return obj && Array.isArray(obj.properties);
}

export function hasSingleProperty(obj: any): obj is { propertyValue: number } {
...
interface MultiViewPickingInfoAssemblerSubscriberCallback {
